...
# DID 和测试数据
DID_BACKUP_SOFTWARE_VERSION_H = 0xF1
DID_BACKUP_SOFTWARE_VERSION_L = 0x90        # F090 备份软件号查询
...
class TestLogger:
    def __init__(self):
        ...
        self.log_path = os.path.join(os.getcwd(), f"UDS_TestLog-版本信息01-015_{timestamp}.txt")
...
def main():
    ...
    # ---------- 测试 22 服务 ----------
    logger.log("\n[测试] 发送 22 F0 90 备份软件号查询")
    req_22 = [SID_22, DID_BACKUP_SOFTWARE_VERSION_H, DID_BACKUP_SOFTWARE_VERSION_L]
