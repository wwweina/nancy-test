...
# DID 和测试数据
DID_FLASH_WRITE_ATTEMPT_COUNTER_H = 0xF0
DID_FLASH_WRITE_ATTEMPT_COUNTER_L = 0xF1            # F0F1 刷写尝试计数器
...
class TestLogger:
    def __init__(self):
        ...
        self.log_path = os.path.join(os.getcwd(), f"UDS_TestLog-版本信息01-020_{timestamp}.txt")
...
def main():
    ...
    req_22 = [SID_22, DID_FLASH_WRITE_ATTEMPT_COUNTER_H, DID_FLASH_WRITE_ATTEMPT_COUNTER_L]
