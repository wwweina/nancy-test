...
class TestLogger:
    def __init__(self):
        ...
        self.log_path = os.path.join(os.getcwd(), f"UDS_TestLog-通用流程-01-011_{timestamp}.txt")
...
def main():
    ...
    logger.log("\n-----------功能寻址28 80 03 测试------------")
    request = [SID_28, SUB_EXTENDED_SESSION, 0x03]
    ...
    logger.log("\n----------------功能寻址28 00 03测试------------")
    req_28 = [SID_28, SUB_DIAGNOSTIC, 0x03]
