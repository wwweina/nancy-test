...
# DID 和测试数据
DID_PROGRAMMING_DEPENDENCY_CHECK_SUCCESS_COUNTER_H = 0xF0
DID_PROGRAMMING_DEPENDENCY_CHECK_SUCCESS_COUNTER_L = 0xF3  # F0F3 编程依赖成功计数器
...
class TestLogger:
    def __init__(self):
        ...
        self.log_path = os.path.join(os.getcwd(), f"UDS_TestLog-版本信息01-021_{timestamp}.txt")
...
def main():
    ...
    req_22 = [SID_22, DID_PROGRAMMING_DEPENDENCY_CHECK_SUCCESS_COUNTER_H, DID_PROGRAMMING_DEPENDENCY_CHECK_SUCCESS_COUNTER_L]
