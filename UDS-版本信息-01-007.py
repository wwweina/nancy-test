...
# DID 和测试数据
DID_BOOTLOADER_VERSION_H = 0xF1
DID_BOOTLOADER_VERSION_L = 0x80                     # F180 Boot版本号
...
class TestLogger:
    def __init__(self):
        ...
        self.log_path = os.path.join(os.getcwd(), f"UDS_TestLog-版本信息01-007_{timestamp}.txt")
...
def main():
    ...
    # ---------- 测试 22 服务 ----------
    logger.log("\n[测试] 发送 22 F1 80 BootLoader版本号查询")
    req_22 = [SID_22, DID_BOOTLOADER_VERSION_H, DID_BOOTLOADER_VERSION_L]
