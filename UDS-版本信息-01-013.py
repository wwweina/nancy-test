...
# DID 和测试数据
DID_VEHICLE_CONFIGURATION_INQUIRY_H = 0xF0
DID_VEHICLE_CONFIGURATION_INQUIRY_L = 0x11   # F011 整车配置
...
class TestLogger:
    def __init__(self):
        ...
        self.log_path = os.path.join(os.getcwd(), f"UDS_TestLog-版本信息01-013_{timestamp}.txt")
...
def main():
    ...
    # ---------- 测试 22 服务 ----------
    logger.log("\n[测试] 发送 22 F0 11 读取整车配置")
    req_22 = [SID_22, DID_VEHICLE_CONFIGURATION_INQUIRY_H, DID_VEHICLE_CONFIGURATION_INQUIRY_L]
