...
# DID 和测试数据
DID_HARDWARE_VERSION_NUMBERS_H = 0xF0
DID_HARDWARE_VERSION_NUMBERS_L = 0x89   # F089 硬件版本号
...
class TestLogger:
    def __init__(self):
        ...
        self.log_path = os.path.join(os.getcwd(), f"UDS_TestLog-版本信息01-014_{timestamp}.txt")
...
def main():
    ...
    # ---------- 测试 22 服务 ----------
    logger.log("\n[测试] 发送 22 F0 89 硬件版本号")
    req_22 = [SID_22, DID_HARDWARE_VERSION_NUMBERS_H, DID_HARDWARE_VERSION_NUMBERS_L]
