...
# DID 和测试数据
DID_FAULT_CODE_AND_FAULT_CODE_NUMBER_MAPPING_H = 0xF0
DID_FAULT_CODE_AND_FAULT_CODE_NUMBER_MAPPING_L = 0x91   # F091 故障码映射
...
class TestLogger:
    def __init__(self):
        ...
        self.log_path = os.path.join(os.getcwd(), f"UDS_TestLog-版本信息01-016_{timestamp}.txt")
...
def main():
    ...
    # ---------- 测试 22 服务 ----------
    logger.log("\n[测试] 发送 22 F0 91 故障码映射")
    req_22 = [SID_22, DID_FAULT_CODE_AND_FAULT_CODE_NUMBER_MAPPING_H, DID_FAULT_CODE_AND_FAULT_CODE_NUMBER_MAPPING_L]
