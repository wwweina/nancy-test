...
# DID 和测试数据
DID_SOFTWARE_PART_NUMBER_H = 0xF0
DID_SOFTWARE_PART_NUMBER_L = 0x13            # F013 软件零件号
...
class TestLogger:
    def __init__(self):
        ...
        self.log_path = os.path.join(os.getcwd(), f"UDS_TestLog-版本信息01-012_{timestamp}.txt")
...
def main():
    ...
    # ---------- 测试 22 服务 ----------
    logger.log("\n[测试] 发送 22 F0 13 软件零件号")
    req_22 = [SID_22, DID_SOFTWARE_PART_NUMBER_H, DID_SOFTWARE_PART_NUMBER_L]
