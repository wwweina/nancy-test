...
# DID 和测试数据
DID_SOFTWARE_VERSION_1_H = 0x02
DID_SOFTWARE_VERSION_1_L = 0x16          # 0216 软件版本号1
...
class TestLogger:
    def __init__(self):
        ...
        self.log_path = os.path.join(os.getcwd(), f"UDS_TestLog-版本信息01-017_{timestamp}.txt")
...
def main():
    ...
    # ---------- 测试 22 服务 ----------
    logger.log("\n[测试] 发送 22 02 16 读取软件版本号1")
    req_22 = [SID_22, DID_SOFTWARE_VERSION_1_H, DID_SOFTWARE_VERSION_1_L]
