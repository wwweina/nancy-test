...
# DID 和测试数据
DID_APPLICATION_SOFTWARE_FINGERPRINT_INFORMATION_H = 0xF1
DID_APPLICATION_SOFTWARE_FINGERPRINT_INFORMATION_L = 0x84  # F184 应用软件指纹
...
class TestLogger:
    def __init__(self):
        ...
        self.log_path = os.path.join(os.getcwd(), f"UDS_TestLog-版本信息01-008_{timestamp}.txt")
...
def main():
    ...
    # ---------- 测试 22 服务 ----------
    logger.log("\n[测试] 发送 22  F1 84 应用软件指纹")
    req_22 = [SID_22, DID_APPLICATION_SOFTWARE_FINGERPRINT_INFORMATION_H, DID_APPLICATION_SOFTWARE_FINGERPRINT_INFORMATION_L]
