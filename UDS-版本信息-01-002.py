...
# DID 和测试数据
DID_SOFTWARE_VERSION_2_H = 0xF1
DID_SOFTWARE_VERSION_2_L = 0x89                     # F189 软件版本号2
...
class TestLogger:
    def __init__(self):
        ...
        self.log_path = os.path.join(os.getcwd(), f"UDS_TestLog-版本信息01-001_{timestamp}.txt")
...
def main():
    ...
    # ---------- 测试 22 服务 ----------
    logger.log("\n[测试] 发送 22 F1 89 软件版本号2")
    req_22 = [SID_22, DID_SOFTWARE_VERSION_2_H, DID_SOFTWARE_VERSION_2_L]
