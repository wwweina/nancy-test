...
# DID 和测试数据
DID_ECU_NAME_H = 0xF1
DID_ECU_NAME_L = 0x97         # F197 ECU名称查询
...
class TestLogger:
    def __init__(self):
        ...
        self.log_path = os.path.join(os.getcwd(), f"UDS_TestLog-版本信息01-005_{timestamp}.txt")
...
def main():
    ...
    # ---------- 测试 22 服务 ----------
    logger.log("\n[测试] 发送 22 F1 97 ECU名称查询")
    req_22 = [SID_22, DID_ECU_NAME_H, DID_ECU_NAME_L]
